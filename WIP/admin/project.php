...
<body>
    ...
    <div class="header">
        ...
        <div class="header-right">
            <a href=# id="invite-link">Invite Code</a>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody class="project-tdbody">
                            ...
                            foreach ($projects as $index => $project) {
                                ...
                                echo "<td>
                                    <div class='dropdown'>
                                        <button class='btn btn-danger dropdown-toggle' type='button' id='dropdownMenuButton{$index}' data-bs-toggle='dropdown' aria-expanded='false'>
                                            Delete
                                        </button>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="manager_select" id="create_manager_select" onchange="updateSelectedManager()">
                                            ...
                                            <?php
                                            $tl_sql = "select DISTINCT employee.first_name, employee.last_name, assigns.project_id  from employee INNER JOIN assigns 
                                            ON employee.emp_id = assigns.emp_id where job_role = 'team_leader' AND is_reg = 'Y' AND assigns.project_id IS NULL";
                                            ...
                                            if ($tl_result->num_rows > 0) {
                                                ...
                                                while($tl_row = $tl_result->fetch_assoc()) {
                                                    ...
                                                    $tl_disabled = $tl_row['project_id'] !== null ? "disabled" : ""; // Check if project_id is not null
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" id="selectedEmployee" name="selected_employees">
                                        ...
                                        <select name="emp_select" id="create_emp_select" onchange="updateSelectedEmployee()">
                                            ...
                                            <?php
                                            $emp_sql = "select DISTINCT employee.first_name, employee.last_name, assigns.project_id  from employee INNER JOIN assigns 
                                            ON employee.emp_id = assigns.emp_id where job_role = 'employee' AND is_reg = 'Y' AND assigns.project_id IS NULL";
                                            ...
                                            if ($emp_result->num_rows > 0) {
                                                ...
                                                while($emp_row = $emp_result->fetch_assoc()) {
                                                    ...
                                                    $e_disabled = $emp_row['project_id'] !== null ? "disabled" : "";
...
<script> 
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function openPopup() {
            ...
            $_SESSION['valid_invite_code'] = $generatedInviteCode;
            inviteCodeInput.value = "hi";
            popup.style.display = 'block';
            document.getElementById("shadow_effect").style.display = "flex";
        }
        ...
        function closePopup() {
            ...
            document.getElementById("shadow_effect").style.display = "none"; 
        }
