...
$inviteCode = isset($_GET['invitecode']) ? sanitize($_GET['invitecode']) : '';
if(empty($inviteCode)) {
    echo "Error: No invite code access granted";
    die();
}

$validInviteCode = isset($_SESSION['valid_invite_code']) ? $_SESSION['valid_invite_code'] : '';
